...
const EditInstitutionData = ({  
    ...
    useEffect(()=>{
        if (dataToBeUpdated === 'institutionDocument' && resourceName === 'Institution'){
            ...
            // console.log('old licence:', oldInstitutionLicence);
            // console.log('old nuit:', oldInstitutionNuit);

            // console.log('newDataObject: ', institutionNuit);
            // console.log('newDataObject: ', institutionLicence);
