...
{ (farmland?.validated === resourceValidation.status.invalidated && customUserData?.role === roles.provincialManager) &&
        <Stack 
        direction="row" 
        w="100%" 
        space={1}
...
{ (customUserData?.role === roles.provincialManager) && (farmland?.validated === resourceValidation.status.pending ) &&
