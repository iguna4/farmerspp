...
const validateFarmerData = (
    ...
    if (!retrievedBirthDistrict){
        setErrors({ ...errors,
            birthDistrict: 'Distrito onde o produtor nasceu.',
        });
        return false;
    }

    if (!retrievedBirthAdminPost){
        setErrors({ ...errors,
    ...
    // if (!retrievedAddressDistrict){
    //     setErrors({ ...errors,
    //         addressDistrict: 'Distrito onde o produtor reside.',
    //     });
    //     return false;
    // }
    ...
    const farmerData = {
        ...
        idDocument: {
            ...
            docNumber: retrievedDocNumber ? retrievedDocNumber : 0, 
